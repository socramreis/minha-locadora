...
<body>
    ...
    <form class="row g-3" method="POST" action="{{ route('client-store') }}">
        ...
        <div class="col-md-2">
            ...
            <input type="date" class="form-control" id="datanascimento" value="{{$client -> datanascimento}}">
          </div>
        <div class="col-4">
        ...
        <div class="col-2">
            ...
            <input type="tel" class="form-control" id="celular" name="celular" value="{{$client -> celular}}">
          </div>
          <div class="col-md-2">
        ...
        <div class="col-4">
          ...
          <input type="text" class="form-control" id="endereco" placeholder="Rua, Avenida" name="endereco" value="{{$client -> endereco}}">
        </div>
        <div class="col-2">
        ...
        <div class="col-3">
            ...
            <input type="text" class="form-control" id="bairro" name="bairro" value="{{$client -> bairro}}">
          </div>
          <div class="col-4">
            <label for="inputAddress2" class="form-label">Complemento</label>
            <input type="text" class="form-control" id="complemento" name="complemento" placeholder="Proximo ao comercio de seu fulano" value="{{$client -> complemento}}">
          </div>
        <div class="col-md-2">
          <label for="inputCity" class="form-label">cidade</label>
          <input type="text" class="form-control" id="cidade" name="cidade" value="{{$client -> cidade}}">
        </div>
        <div class="col-md-1">
            <label for="inputCity" class="form-label">estado</label>
            <input type="text" class="form-control" id="cidade" name="estado" value="{{$client -> estado}}">
        </div>
      <!--  <div class="col-md-1">
