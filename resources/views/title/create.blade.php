...
<body>
    ...
    <form class="row g-3">
        <div class="col-md-6">
          ...
          <input type="email" class="form-control" id="inputEmail4" name="nometitle">
        </div>
        <div class="col-md-2">
          <label for="inputPassword4" class="form-label">Ano Lançamento</label>
          <input type="date" class="form-control" id="inputPassword4" name="anotitle">
        </div>
        <div class="col-md-2">
        ...
        <div class="col-2">
          ...
          <input type="text" class="form-control" id="inputAddress" placeholder="multatitle">
                ...
                <div class="col-12">
            <a type="submit" class="btn btn-success" href="{{ route('title-store') }}">Cadastrar</a>
        </div>
      </form>
